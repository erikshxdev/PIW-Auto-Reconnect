...
- Se o WebSocket permanecer fechado, grava o estado da Hunt antes do reload.
- Após o reload, o mesmo script espera o novo WebSocket abrir e tenta restaurar a Hunt usando o `slug` salvo.
